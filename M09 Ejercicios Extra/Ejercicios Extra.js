...
function asAmirror(frase) {
   ...
   var toArray = frase.split(' ')
   var fraseFinal = toArray.map(function(ele){
...
function capicua(numero) {
   ...
   var esCapicua = convertir.split('').reverse().join('');

   if (esCapicua === convertir){
      return 'Es capicua'
   } else {
